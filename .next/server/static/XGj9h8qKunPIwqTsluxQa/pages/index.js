...
function (_React$Component) {
  ...
  function SingleProject(props) {
    ...
    _this.switchCollapse = _this.switchCollapse.bind(SingleProject_assertThisInitialized(SingleProject_assertThisInitialized(_this)));
    return _this;
  }
  ...
  SingleProject_createClass(SingleProject, [{
    ...
    value: function render() {
      ...
      external_react_["createElement"]("div", {
        ...
        delay: 150
      }, external_prismic_reactjs_["RichText"].render(project.description_collapse))), external_prismic_reactjs_["RichText"].asText(project.description_collapse) !== '' ? external_react_["createElement"]("button", {
        type: "button",
        onClick: function onClick() {
          return _this2.switchCollapse();
        },
        className: "jsx-1245384857" + " " + "button has-text-weight-bold is-dark"
      }, isCollapseActive ? 'Show less' : 'Show more') : '')), external_react_["createElement"]("div", {
...
var Education_Education = function Education() {
  return external_react_default.a.createElement("div", {
  ...
  }, "University of Social Sciences"), external_react_default.a.createElement("h6", {
    className: "jsx-3211479755" + " " + "is-uppercase"
    ...
    className: "jsx-3211479755" + " " + "is-uppercase"
  }, "Machine Building College"), external_react_default.a.createElement("h6", {
    className: "jsx-3211479755" + " " + "is-uppercase"
  }, external_react_default.a.createElement("i", {
    className: "jsx-3211479755" + " " + "fas fa-map-marker-alt"
